...
import com.xdu.yygh.hosp.repository.DepartmentRepository;
...
public class DepartmentServiceImpl implements DepartmentService {
    ...
    public void save(Map<String, Object> paramMap) {
        ...
        if(departmentExist!=null) {
         ...
         //   departmentExist.setId(departmentExist.getId());
...
//删除科室
    ...
    public List<DepartmentVo> findDeptTree(String hoscode) {
        ...
        Map<String, List<Department>> deparmentMap =
                departmentList.stream().collect(Collectors.groupingBy(Department::getBigcode));//根据Bigcode进行分组，分出来就是键值对，键是bigcode，值是大课室下的小科室list
