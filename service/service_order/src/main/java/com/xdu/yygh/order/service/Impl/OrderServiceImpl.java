...
import com.xdu.common.rabbit.service.RabbitService;
...
import com.xdu.yygh.model.user.Patient;
import com.xdu.yygh.order.mapper.OrderMapper;
import com.xdu.yygh.order.service.OrderService;
import com.xdu.yygh.user.client.PatientFeignClient;
import com.xdu.yygh.vo.hosp.ScheduleOrderVo;
import com.xdu.yygh.vo.msm.MsmVo;
import com.xdu.yygh.vo.order.OrderMqVo;
...
//短信提示
            ...
            System.out.println(orderMqVo.toString());
    ...
    @Override
    public IPage<OrderInfo> selectPage(com.baomidou.mybatisplus.extension.plugins.pagination.Page<OrderInfo> pageParam, OrderQueryVo orderQueryVo) {
//orderQueryVo获取条件值
